...
void guardarInformacao(int posicaoCache, int tamanhoCache, int conjuntoCache1, int conjuntoCache2, int conjuntoCache3,  Endereco *endAux);
void desatualizaCaches(int posicaoCacheX, int posicaoCacheY, int tamanhoCache);
...
BlocoMemoria* buscarNasMemorias(Endereco* end){
    ...
    guardarInformacao(posicaoCache3, tamanhoCache3, conjuntoCache1, conjuntoCache2, conjuntoCache3, end);
    ...
    guardarInformacao(posicaoCache2, tamanhoCache2, conjuntoCache1, conjuntoCache2, conjuntoCache3, end);

    cache2[posicaoCache2] = cache3[posicaoCache3];
    desatualizaCaches(posicaoCache2, posicaoCache3, tamanhoCache3);

    int posicaoCache1 = algoritmoSubstituicaoLRU(conjuntoCache1, tamanhoCache1);
    guardarInformacao(posicaoCache1, tamanhoCache1, conjuntoCache1, conjuntoCache2, conjuntoCache3, end);

    cache1[posicaoCache1] = cache2[posicaoCache2];
    desatualizaCaches(posicaoCache1, posicaoCache2, tamanhoCache3);
...
void desatualizaCache(int posicaoCacheX, int posicaoCacheY, int tamanhoCache){
